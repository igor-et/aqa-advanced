...
let firstName = "The first name";
let secondName = "The secong name";
let strGreeting = "Hello and congrats";
let strConcat = strGreeting + " " + firstName +  " and " + secondName;
console.log(strConcat);

let strGreetingTemplate = `${strGreeting} ${firstName} and ${secondName}`;
console.log(strGreetingTemplate);